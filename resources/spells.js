var spells={
	...
	"Create or Destroy Water": {
		...
		"components": {
			"material": true,
			"materials_needed": ["a drop of water if creating water, or a few grains of sand if destroying it"],
	...
	"Find Familiar": {
		...
		"components": {
			"material": true,
			"materials_needed": ["10gp worth of charcoal, incense, and herbs that must be consumed by fire in a brass brazier"],
	...
	"Warding Bond": {
		...
		"components": {
			"material": true,
			"materials_needed": ["a pair of platinum rings worth at least 50 gp each, which you and the target must wear for the duration"],
	...
	"Clairvoyance": {
		...
		"components": {
			"material": true,
			"materials_needed": ["a focus worth at least 100gp, either a jeweled horn for hearing or a glass eye for seeing"],
	...
	"Hypnotic Pattern": {
		...
		"components": {
			"material": true,
			"materials_needed": ["a glowing stick of incense or a crystal vial filled with phosphorescent material"],
	...
	"Magic Circle": {
		...
		"components": {
			"material": true,
			"materials_needed": ["holy water or powdered silver and iron worth at least 100 gp, which the spell consumes"],
	...
	"Nondetection": {
		...
		"components": {
			"material": true,
			"materials_needed": ["a pinch of diamond dust worth 25 gp sprinkled over the target, which the spell consumes"],
	...
	"Antipathy/Sympathy": {
		...
		"components": {
			"material": true,
			"materials_needed": ["either a hump of alum soaked in vinegar for the _antipathy_ effect or a drop of honey for the _sympathy_ effect"],
	...
	"Astral Projection": {
		...
		"components": {
			"material": true,
			"materials_needed": ["for each creature you affect with this spell you must provide one jacinth worth at least 1,000 gp and one ornately carved bar of silver worth at least 100gp, all of which the spell consumes"],
	...
	"Holy Aura": {
		...
		"components": {
			"material": true,
			"materials_needed": ["a tiny reliquary worth at least 1,000 gp containing a sacred relic, such as a scrap of cloth from a saint's robe or a piece of parchment from a religious text"],
	...
	"Imprisonment": {
		...
		"components": {
			"material": true,
			"materials_needed": ["a vellum depiction or a carved statuette in the likeness of the target, and a special component that varies according to the version of the spell you choose, worth at least 500 gb per Hit Die of the target"],
	...
	"Shapechange": {
		...
		"components": {
			"material": true,
			"materials_needed": ["a jade circlet worth at least 1,500 gp, which you must place on your head before you cast the spell"],
	...
	"True Resurrection": {
		...
		"components": {
			"material": true,
			"materials_needed": ["a sprinkle of holy water and diamonds worth at least 25,000 gp, which the spell consumes"],
	...
	"Plane Shift": {
		...
		"components": {
			"material": true,
			"materials_needed": ["a forked, metal rod worth at least 250 gp, attuned to a particular plane of existence"],
	...
	"Sequester": {
		...
		"components": {
			"material": true,
			"materials_needed": ["a powder of diamond, emerald, rube and sapphire dust worth at least 5,000 gp, which the spell consumes"],
	...
	"Simulacrum": {
		...
		"components": {
			"material": true,
			"materials_needed": ["snow or ice in quantities sufficient to made a life-size copy of the duplicated creature; some hair, fingernail clippings, or other piece of that creature's body placed inside the snow or ice; and powdered ruby worth 1,500 gp, sprinkled over the duplicate and consumed by the spell"],
	...
	"Symbol": {
		...
		"components": {
			"material": true,
			"materials_needed": ["mercury, phosphorus, and powdered diamond and opal with a total value of at least 1,000 gp, which the spell consumes"],
	...
	"Chain Lightning": {
		...
		"components": {
			"material": true,
			"materials_needed": ["a bit of fur; a piece of amber, glass or a crystal rod; and three silver pins"],
	...
	"Conjure Elemental": {
		...
		"components": {
			"material": true,
			"materials_needed": ["burning incense for air, soft clay for earth, sulfur and phosphorus for fire, or water and sand for water"],
	...
	"Contingency": {
		...
		"components": {
			"material": true,
			"materials_needed": ["a statuette of yourself carved from ivory and decorated with gems worth at least 1,500 gp"],
	...
	"Create Undead": {
		...
		"components": {
			"material": true,
			"materials_needed": ["one clay pot filled with grave dirt, one clay pot filled with brackish water, and one 150 gp black onyx stone for each corpse"],
	...
	"Divination": {
		...
		"components": {
			"material": true,
			"materials_needed": ["incense and a sacrificial offering appropriate to your religion, together worth at least 25 gp, which the spell consumes"],
	...
	"Dream": {
		...
		"components": {
			"material": true,
			"materials_needed": ["a handful of sand, a dab of ink, and a writing quill plucked from a sleeping bird"],
	...
	"Find the Path": {
		...
		"components": {
			"material": true,
			"materials_needed": ["a set of divinatory tools -- such as bones, ivory sticks, cards, teeth, or carved runes -- worth 100 gp and an object from the location you wish to find"],
	...
	"Forbiddance": {
		...
		"components": {
			"material": true,
			"materials_needed": ["a sprinkling of holy water, rare incense, and powdered ruby worth at least 1000 gp"],
	...
	"Gentle Repose": {
		...
		"components": {
			"material": true,
			"materials_needed": ["a pinch of salt and one copper piece placed on each of the corpse's eyes, which must remain there for the duration"],
	...
	"Glyph of Warding": {
		...
		"components": {
			"material": true,
			"materials_needed": ["incense and powdered diamond worth at least 200 gp, which the spell consumes"],
	...
	"Guards and Wards": {
		...
		"components": {
			"material": true,
			"materials_needed": ["burning incense, a small measure of brimstone and oil, a knotled string, a small amount of umber hulk blood, and a small silver rod worth at least 10 gp"],
	...
	"Hallow": {
		...
		"components": {
			"material": true,
			"materials_needed": ["herbs, oils, and incense worth at least 1,000 gp, which the spell consumes"],
	...
	"Legend Lore": {
		...
		"components": {
			"material": true,
			"materials_needed": ["incense worth at least 250 gp, which the spell consumes, and four ivory strips worth at least 50 gp each"],
	...
	"Levitate": {
		...
		"components": {
			"material": true,
			"materials_needed": ["either a small leather loop or a pieee of golden wire bent into a cup shape with a long shank on one end"],
	...
	"Magic Jar": {
		...
		"components": {
			"material": true,
			"materials_needed": ["a gem, crystal, reliquary, or some other ornamental container worth at least 500 gp"],
	...
	"Magic Mouth": {
		...
		"components": {
			"material": true,
			"materials_needed": ["a small bit of honeycomb and jade dust worth at least 10 gp, which the spell consumes"],
	...
	"Move Earth": {
		...
		"components": {
			"material": true,
			"materials_needed": ["an iron blade and a small bag containing a mixture of soils--c1ay, loam, and sand"],
	...
	"Reincarnate": {
		...
		"components": {
			"material": true,
			"materials_needed": ["rare oils and unguents worth at least 1,000 gp, which the spell consumes"],
	...
	"Scrying": {
		...
		"components": {
			"material": true,
			"materials_needed": ["a focus worth at least 1,000 gp, such as a crystal ball, a silver mirror, or a font filled with holy water"],
	...
	"Stone Shape": {
		...
		"components": {
			"material": true,
			"materials_needed": ["soft clay, which must be worked into roughly the desired shape of the stone object"],
	...
	"Teleportation Circle": {
		...
		"components": {
			"material": true,
			"materials_needed": ["rare chalks and inks infused with precious gems with 50 gp, which the spell consumes"],
	...
	"True Seeing": {
		...
		"components": {
			"material": true,
			"materials_needed": ["an ointment for the eyes that costs 25 gp, is made from mushroom powder, saffron, and fat, and is consumed by the spell"],
